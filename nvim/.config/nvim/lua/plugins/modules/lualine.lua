return {
  ...
  opts = function()
    ...
    local lualine_presets = {
      everforest = {
        space = { bg = colors.everforest.bg0, fg = "" },
      ...
      catppuccin_frappe = {
        space = { bg = colors.catppuccin_frappe.base, fg = "" },
    ...
    if vim.g.colors_name == 'everforest' then
      ...
      lualine_theme.normal.c.bg = colors.everforest.bg0
      lualine_theme.insert.c.bg = colors.everforest.bg0
      lualine_theme.visual.c.bg = colors.everforest.bg0
      lualine_theme.replace.c.bg = colors.everforest.bg0
      lualine_theme.command.c.bg = colors.everforest.bg0
      lualine_theme.inactive.c.bg = colors.everforest.bg0
      lualine_theme.terminal.c.bg = colors.everforest.bg0

      theme = lualine_theme
      palette = lualine_presets.everforest
    elseif vim.g.colors_name == 'catppuccin-frappe' then
      local lualine_theme = require('lualine.themes.catppuccin-frappe')
      lualine_theme.normal.c.bg = colors.catppuccin_frappe.base
      theme = lualine_theme
      palette = lualine_presets.catppuccin_frappe
    end
